...
\pagenumbering{gobble} % No page numbers on the title page% Insert the image
\begin{titlepage}
\centering
    \vspace{0.2cm}
    ...
    \medium{DEPARTMENT OF STATISTICS AND ACTUARIAL SCIENCE}
    \vspace{0.2cm}
...
of Science and Technology (KNUST) - A Survival
Analysis Approach}
    \vspace{0.2cm}
...
\bibitem{Evrensel2008} Evrensel, A. Y. (2008). Banking Crisis and Financial Structure: A Survival-Time Analysis. International Review of Economics & Finance, 17(4), 589-602.
